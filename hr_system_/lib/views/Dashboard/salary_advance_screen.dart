...
import '../../controllers/Dashboard/salary_advance_controller.dart';
import '../employee_nav_bar.dart';

class SalaryAdvanceScreen extends StatelessWidget {
  SalaryAdvanceScreen({Key? key}) : super(key: key);

  final SalaryAdvanceController controller = Get.put(SalaryAdvanceController());
                      ...
                      () => Column(
                        ...
                        children: [
                          ...
                          TextField(
                            ...
                            decoration: InputDecoration(
                              hintText: "Enter month (e.g. 7 or July)...",
                              filled: true,
                              fillColor: Colors.grey.shade100,
                              contentPadding: const EdgeInsets.symmetric(
                                horizontal: 14,
